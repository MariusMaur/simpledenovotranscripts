...
def create_sra_yaml(table_path):
...
def create_local_yaml(table_path):
    # Convert the table path to its absolute path
    absolute_table_path = os.path.abspath(table_path)
...
def main():
    ...
    # Run Snakemake with the --sra option
    if args.sra:
        print("\n---------------------\n| Fetching SRA data |\n---------------------\n")
        fetch_sra_data(args.sra)
        print("\n-----------------------------------------------\n| SRA fetch done --> moving to yaml creation! |\n-----------------------------------------------\n")
        create_sra_yaml(args.sra)
        print("\n-----------------------------------------------\n| sra.yaml has been created in yaml directory |\n|     Snakemake pipeline started with SRA     |\n-----------------------------------------------\n")
    ...
    # Run Snakemake with the --local option
    elif args.local:
        create_local_yaml(args.local)
        print("\n-------------------------------------------------\n| local.yaml has been created in yaml directory |\n|  Snakemake pipeline started with local data   |\n-------------------------------------------------\n")
